...
<head>
    <meta charset="utf-8">
    <title><?php echo date('d_m_Y'); ?>_Rekap_Laporan_izin</title>
...
<body onload="window.print()">
    ...
    <table width="100%">
        <tr>
            ...
            <td align="left">
                <p class="name-school"><b><?php echo $md->madrasah; ?></p>
    ...
    <hr>
    <h3 align="center">DAFTAR LAPORAN DATA IZIN SISWA<br>TAHUN<?php echo date('Y') ?></h3>
