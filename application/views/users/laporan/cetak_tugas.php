...
<head>
  <meta charset="utf-8">
  <title><?php echo date('d_m_Y'); ?>_Rekap_Laporan_tugas</title>
...
<body onload="window.print()">
  ...
  <hr>
  <h3 align="center">DAFTAR LAPORAN DATA TUGAS PEGAWAI<br>TAHUN<?php echo date('Y') ?></h3>
  ...
  <table border="1" width="100%">
    ...
    foreach ($sql->result() as $baris) { ?>
      <tr>
        <td><?php echo $no; ?></td>
        <td>
          <b></b> <?php echo $baris->nama_pegawai; ?><br>
        </td>
        <td>
          <b></b> <?php echo $baris->nip_pegawai; ?><br>
        </td>
