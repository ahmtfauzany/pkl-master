                ...
                <div class="form-group">
                  <div class="col-lg-12">
                    <div class="input-group">
                      ...
                      <input type="text" name="asal_instansi" id="asal_instansi" value="<?php echo $query->asal_instansi; ?>" class="form-control" placeholder="Asal Instansi Surat" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-lg-12">
                      <div class="input-group">
                        ...
                        <input type="text" name="tgl_sk" class="form-control daterange-single" id="tgl_sk" value="<?php echo $query->tgl_sk; ?>" maxlength="10" required placeholder="Tanggal Surat Keluar" readonly>
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        <div class="col-lg-12">
                          <div class="input-group">
                            ...
                            <input type="text" name="no_surat" id="no_surat" value="<?php echo $query->no_surat; ?>" class="form-control" placeholder="No Surat" readonly>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="col-lg-12">
                            <div class="input-group">
                              ...
                              <input type="text" name="perihal" id="perihal" value="<?php echo $query->perihal; ?>" class="form-control" placeholder="Perihal Surat" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            <div class="col-lg-12">
                              <div class="input-group">
                                ...
                                <input type="text" name="tgl_kegiatan" class="form-control daterange-single" id="tgl_kegiatan" value="<?php echo $query->tgl_kegiatan; ?>" maxlength="10" required placeholder="Tanggal Surat Keluar" readonly>
                              </div>
                            </div>
