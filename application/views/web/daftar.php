...
<div class="panel panel-body login-form">
  ...
  <!-- <div class="form-group has-feedback has-feedback-left">
      <select class="form-control" name="pegawai" required>
          ...
          foreach ($pegawai as $baris) {
            echo '<option value="' . $baris->id_pegawai . '">' . $baris->nama_pegawai . '</option>';
          } ?>
      </select>
      <div class="form-control-feedback">
  ...
  <div id="data">
    <form action="#" id="form-daftar">
      ...
      <div class="form-group has-feedback has-feedback-left">
        <input type="text" class="form-control" placeholder="pegawai" name="pegawai" required readonly>
        <div class="form-control-feedback">
          <i class="icon-price-tag2 text-muted"></i>
        </div>
      </div>
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (data.status == "gagal" || data.status == "proses") {
              ...
              $('[name="pegawai"]').val(data.status.nama_pegawai);
