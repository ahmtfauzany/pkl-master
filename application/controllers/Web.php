...
class Web extends CI_Controller
{
			...
			if (isset($_POST['btnlogin'])) {
				...
				if ($jumlah == 0) {
					...
					if ($cekpass <> $pass) {
						...
						$this->session->set_userdata('AhmadFauzan', "$cekun");
						$this->session->set_userdata('zan', "$row->id_user");
	...
	{
		if ($this->session->has_userdata('AhmadFauzan') and $this->session->has_userdata('AhmadFauzan')) {
