...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Feb 2024 pada 16.37
...
INSERT INTO `tbl_cuti` (`id_cuti`, `nip`, `tgl_ns`, `no_asal`, `tgl_no_asal`, `pengirim`, `perihal`, `token_lampiran`, `bagian`, `disposisi`, `id_user`, `tgl_cuti`, `tgl_awal`, `tgl_akhir`, `lama`, `lampiran`, `status`, `sifat`, `dibaca`, `tgl_ajuan`, `segera`, `biasa`, `catatan`, `tgl_disposisi`) VALUES
(113, '197310122000121002', '19-02-2024', 'undefined', '', 'Ahmad Fauzan Pegawai', 'a', 'a931fdbe47dcd76152500d5686a5575c', NULL, NULL, 15, '2024-02-19', '2024-02-19', '2024-02-20', '1', 'undefined', 'undefined', 'undefined', 2, '2024-02-19', NULL, NULL, 'a', NULL),
(110, '197310122000121002', '19-02-2024', 'undefined', '', 'Ahmad Fauzan Pegawai', 'a', '980a0ff672a5dcbe9c06144e5dc6b08a', NULL, NULL, 15, '2024-02-19', '2024-02-19', '2024-02-20', '1', 'undefined', 'undefined', 'undefined', 1, 'undefined', NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `tbl_cuti`
  MODIFY `id_cuti` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;
...
--
ALTER TABLE `tbl_lampiran`
  MODIFY `id_lampiran` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;
