...
INSERT INTO `tbl_pegawai` (`id_pegawai`, `nama_pegawai`, `nip`, `pangkat`, `id_user`) VALUES
...
INSERT INTO `tbl_siswa` (`id`, `nim`, `nisn`, `nama_siswa`, `ttl`, `kelas`, `jurusan`, `nama_orangtua`, `alamat`, `id_user`) VALUES
...
INSERT INTO `tbl_sk` (`id_sk`, `no_sk`, `tgl_kegiatan`, `no_sm`, `tgl_sk`, `kode`, `alasan`, `asal_instansi`, `token_lampiran`, `id_user`, `pelaksana`, `pegawai`, `peringatan`) VALUES
...
INSERT INTO `tbl_sm` (`id_sm`, `no_sm`, `tgl_ns`, `no_surat`, `tgl_no_surat`, `nama_pegawai`, `penerima`, `alasan`, `token_lampiran`, `pegawai`, `disposisi`, `id_user`, `tgl_sm`, `lampiran`, `status`, `sifat`, `dibaca`, `tgl_disetujui`, `segera`, `biasa`, `catatan`, `tgl_disposisi`) VALUES
