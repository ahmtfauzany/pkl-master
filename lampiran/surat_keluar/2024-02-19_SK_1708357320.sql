...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Feb 2024 pada 23.17
...
INSERT INTO `tbl_cuti` (`id_cuti`, `nip`, `tgl_ns`, `no_surat`, `nama_pg`, `tgl_no_surat`, `nama_pegawai`, `penerima`, `alasan`, `token_lampiran`, `bagian`, `disposisi`, `id_user`, `tgl_cuti`, `tgl_awal`, `tgl_akhir`, `lama`, `lampiran`, `status`, `sifat`, `dibaca`, `tgl_disetujui`, `segera`, `biasa`, `catatan`, `tgl_disposisi`) VALUES
(93, 'undefined', '13-02-2024', 'undefined', '', '', 'Ahmad Fauzan Pegawai', 'undefined', 'Sakit', '231c306c5971d1233bdf4be188ebd2a5', NULL, NULL, 15, '2024-02-13', NULL, NULL, NULL, 'undefined', 'undefined', 'undefined', 2, '2024-02-13', NULL, NULL, 'Ok siap', NULL),
(94, 'undefined', '18-02-2024', 'undefined', '', '', 'Ahmad Fauzan Kepsek', 'undefined', 'a', '10655e57dbcdebc455314d846052f78c', NULL, NULL, 14, '2024-02-18', NULL, NULL, NULL, 'undefined', 'undefined', 'undefined', 1, 'undefined', NULL, NULL, NULL, NULL),
(95, 'undefined', '18-02-2024', 'undefined', '', '', 'Ahmad Fauzan Kepsek', 'undefined', 'a', 'e47433a6f6b974d7cda204c946f095f5', NULL, NULL, 14, '2024-02-18', NULL, NULL, NULL, 'undefined', 'undefined', 'undefined', 1, 'undefined', NULL, NULL, NULL, NULL),
(102, '', '19-02-2024', '', '', '', 'Ahmad Fauzan S_admin', '', 'a', '97af1316fc926bd677ab317fa796e4e0', NULL, NULL, 7, '2024-02-19', '2024-02-20', '2024-02-28', '8', '', '', '', 1, '', NULL, NULL, NULL, NULL),
(104, 'undefined', '19-02-2024', 'undefined', '', '', 'Ahmad Fauzan S_admin', 'undefined', 'a', 'cabca3cc69b5bdd734220631192026dc', NULL, NULL, 7, '2024-02-19', '', '', NULL, 'undefined', 'undefined', 'undefined', 1, 'undefined', NULL, NULL, NULL, NULL);
...
INSERT INTO `tbl_sm` (`id_sm`, `no_sm`, `tgl_ns`, `no_surat`, `tgl_no_surat`, `tgl_awal`, `tgl_akhir`, `nama_pegawai`, `penerima`, `alasan`, `token_lampiran`, `pegawai`, `disposisi`, `id_user`, `tgl_sm`, `lampiran`, `status`, `sifat`, `dibaca`, `tgl_disetujui`, `segera`, `biasa`, `catatan`, `tgl_disposisi`) VALUES
...
(14, 'Ahmad Fauzan Kepsek', NULL, '6ac86d71b0f938e0c671caeff1ea82b5', 'Ahmad Fauzan Kepsek', '-', '-', '-', '-', 'kepsek', 'aktif', '27-01-2024 01:26:09', '18-02-2024 21:45:31'),
(6, 'Ahmad Fauzan Admin', NULL, 'e66b68f6c149d36c9332c6e7882c4fc7', 'Ahmad Fauzan Admin', '085252269845', 'bjb', 'it', '-turue', 'admin', 'aktif', '23-01-2024 19:03:34', '18-02-2024 22:01:13'),
(7, 'Ahmad Fauzan S_admin', '197310122000121002', '0888a28f39a3092b5002452347e0c156', 'Ahmad Fauzan S_admin', '085252269845', 'bjb', 'web dev', 'gambar', 's_admin', 'aktif', '18-02-2024 22:07:52', '18-02-2024 22:25:10');
...
--
ALTER TABLE `tbl_cuti`
  MODIFY `id_cuti` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;

--
-- AUTO_INCREMENT untuk tabel `tbl_izin`
--
ALTER TABLE `tbl_izin`
  MODIFY `id_izin` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT untuk tabel `tbl_lampiran`
--
ALTER TABLE `tbl_lampiran`
  MODIFY `id_lampiran` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;
...
--
ALTER TABLE `tbl_pegawai`
  MODIFY `id_pegawai` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `tbl_sk`
  MODIFY `id_sk` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbl_tugas`
  MODIFY `id_tugas` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
