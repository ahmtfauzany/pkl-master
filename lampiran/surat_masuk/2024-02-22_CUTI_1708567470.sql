...
INSERT INTO `tbl_cuti` (`id_cuti`, `nip`, `tgl_ns`, `no_asal`, `nama_pg`, `tgl_no_asal`, `pengirim`, `penerima`, `perihal`, `token_lampiran`, `bagian`, `disposisi`, `id_user`, `tgl_cuti`, `tgl_awal`, `tgl_akhir`, `lama`, `lampiran`, `status`, `sifat`, `dibaca`, `tgl_ajuan`, `segera`, `biasa`, `catatan`, `tgl_disposisi`) VALUES
