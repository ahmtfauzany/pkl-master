...
INSERT INTO `tbl_sk` (`id_sk`, `id_surat`, `tgl_id_surat`, `no_sm`, `tgl_sk`, `kode`, `perihal`, `tujuan`, `token_lampiran`, `id_user`, `pelaksana`, `bagian`, `peringatan`) VALUES
...
INSERT INTO `tbl_sm` (`id_sm`, `no_sm`, `tgl_ns`, `no_surat`, `tgl_no_surat`, `asal_instansi`, `penerima`, `perihal`, `token_lampiran`, `bagian`, `disposisi`, `id_user`, `tgl_sm`, `lampiran`, `status`, `sifat`, `dibaca`, `tgl_ajuan`, `segera`, `biasa`, `catatan`, `tgl_disposisi`) VALUES
